...
;;
;; $Log: pprint.lisp,v $
;; Revision 1.2  2003-05-18 08:56:19  gilbert
;; - added a few notes
;; - stream-pprint-newline and stream-pprint-indent are now no-ops when
;;   no pretty printing is effect as they should.
;; - it is no longer neccessary to load the file twice.
;;
;;
